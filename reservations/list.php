								...
								<div class="table-wrapper">
										<table class="alt">
											...
											<tbody>
												...
												<?php
													$bookingQuery = mysqli_query($db, "SELECT * FROM pnr INNER JOIN booking ON pnr.ID = booking.clientID INNER JOIN flight ON booking.flightNumber = flight.flightNumber WHERE booking.user = '". $_SESSION['user'] . "' ORDER BY booking.addDate DESC, booking.addTime DESC");
								...
								<div class="table-wrapper">
										<table class="alt">
											...
											<tbody>
												...
												<?php
													$bookingQuery = mysqli_query($db, "SELECT * FROM pnr INNER JOIN bookingr ON pnr.ID = bookingr.clientID WHERE bookingr.user = '". $_SESSION['user'] . "' GROUP BY (bookingr.bookingID AND pnr.ID) ORDER BY bookingr.addDate DESC, bookingr.addTime DESC");

									...
									<section>
										<form method="post" action="add_client-config.php">
											<div class="row gtr-uniform">
												...
												<div class="col-4 col-12-xsmall">	
													<h2>Middle Name</h2>
													<input type="text" name="clientMiddleName" id="clientMiddleName" value="$clientMiddleName" placeholder="Middle Name" />
												</div>
												<div class="col-4 col-12-xsmall">
													<h2>Last Name</h2>
													<input type="text" name="clientLastName" id="clientLastName" value="$clientLastName" placeholder="Last Name" required/>

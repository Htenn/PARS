									...
									<div class="content">
										...
										<div class="col-6 col-12-medium">
											<ul class="actions stacked">
												<li><a href="#" class="button primary fit">FLIGHT AVAILABILITY</a></li>
												<li><a href="#" class="button primary fit">BOOK FLIGHT</a></li>
												<li><a href="#" class="button primary fit">MANAGE CLIENTS</a></li>
												<li><a href="#" class="button primary fit">VIEW REPORTS</a></li>
											</ul>
										</div>
